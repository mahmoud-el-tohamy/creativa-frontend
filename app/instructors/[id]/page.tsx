...
function InstructorProfileContent({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (state.loading || !state.instructor) {
    return (
      <div className="min-h-screen bg-[#F8F8F7] dark:bg-gray-900 transition-colors flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen bg-[#F8F8F7] dark:bg-gray-900 transition-colors pb-12" dir="rtl">
