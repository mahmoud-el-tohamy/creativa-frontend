...
function getCalendarYearForFYMonth(
  calMonth: number,
  startYear: number,
): number {
          ...
          <div className="flex gap-2 mt-4">
            <button
              onClick={() => {
                ...
                dispatch({ type: "SET_TAB", tab: "timetable" });
              }}
...
const ComparisonChart = React.memo(function ComparisonChart({
  data,
...
function HoursPageContent() {
  ...
  const [deleteTarget, setDeleteTarget] = useState<TrainingSession | null>(
    null,
  );
